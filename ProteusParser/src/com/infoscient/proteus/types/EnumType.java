...
/**
 * Annotation to specify attributes for a enumeration variable, which is just a
 * string that has a specific set of valid values
 * 
 * @author jasleen
 * 
 */
...
public @interface EnumType {
	 ...
	 * 
	 * @return Set of allowed values, as a string array
	 */
	public String[] allowed();

	/**
	 * Can be one of: 1. "c": ComboBox 2. "r": RadioButtons
	 * 
	 * @return type of widget to be generated
	 */
	public String type() default "c";
}