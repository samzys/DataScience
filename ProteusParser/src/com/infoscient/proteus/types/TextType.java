...
/**
 * Annotation to specify attributes for a text variable. A text variable is of
 * type <code>String</code> and is usually used for variables storing longer
 * pieces of text, and has a different corresponding UI element compared to
 * <code>String</code>
 * 
 * @author jasleen
 * 
