...
/**
 * Property type encapsulating a Marker object
 * 
 * @author jasleen
 * 
 */
public class MarkerProperty extends Property {

	/**
	 * @see Property#Property(String, String, String, boolean)
	 */
	public MarkerProperty(String name, String category, String description,
			boolean readonly) {
	 ...
	 */
	public MarkerProperty(PropertyDescriptor pd, Object obj, String category,
			boolean readonly) {
	 ...
	 */
	public MarkerProperty(Field field, Object obj, String name,
	 ...
	 */
	public MarkerProperty(Field field, Object obj, MarkerType type) {
	 ...
	 */
	public MarkerProperty(MarkerProperty prop, String name, String category,
