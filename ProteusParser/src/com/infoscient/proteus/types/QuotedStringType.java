...
/**
 * Annotation to specify attributes for a quoted string variable. A quoted
 * string is of type <code>String</code> but always has '"' at its ends
 * 
 * @author jasleen
 * 
 */
...
public @interface QuotedStringType {
	/**
