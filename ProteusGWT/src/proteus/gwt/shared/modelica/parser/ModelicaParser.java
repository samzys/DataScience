...
//	    root.dump("");
	...
	*/
	 ...
	 jjtree.openNodeScope(jjtn000);Token t;
	  ...
	  jjtree.openNodeScope(jjtn000);
	    ...
	    jjtn000.replaceable = "replaceable";
	          switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
	          case BLOCK:
	          case CLASS:
	          case CONNECTOR:
	...
	*/
	...
	String s = t.image;
	  ...
	  public ModelicaParser(InputStream stream) {
	     this(stream, null);
	  }
	  /** Constructor with InputStream and supplied encoding */
	  public ModelicaParser(InputStream stream, String encoding) {
	  ...
	  /** Constructor. */
	  public ModelicaParser(Reader stream) {
